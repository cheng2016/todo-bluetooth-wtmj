...
public class GoogleParser extends XMLParser implements Parser {
       ...
       // System.out.println(result);
        ...
        try {
            ...
            for (int i = 0; i < jsonRoutes.length(); i++) {
                ...
                Route route = parseRoute(jsonRoute);
    ...
    public  Route parseRoute(JSONObject jsonRoute) throws JSONException{
        Route route = new Route();
        //Create an empty segment

      //  System.out.println("JSONObject "+jsonRoute.toString());
        /*JsonElement jelement = new JsonParser().parse(jsonRoute.toString());
        System.out.println("jelement "+jelement.getAsString());*/
...
//            LogUtils.e("polyline","segmentpolyline==="+decodePolyLine(step.getJSONObject("polyline").getString("points")));
            segment.addPoints(decodePolyLine(step.getJSONObject("polyline").getString("points")));//add by wr

            //Retrieve & decode this segment's polyline and add it to the route.
            route.addPoints(decodePolyLine(step.getJSONObject("polyline").getString("points")));
            //Push a copy of the segment to the route
            route.addSegment(segment);
//            LogUtils.e("polyline","routepolyline==="+route.getPoints());
        }
        return route;
    }
    /**
