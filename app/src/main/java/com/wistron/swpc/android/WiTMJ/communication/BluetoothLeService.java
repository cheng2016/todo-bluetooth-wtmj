...
package com.wistron.swpc.android.WiTMJ.communication;
...
public class BluetoothLeService extends Service {
    ...
    public static final UUID HEART_RATE_SERVICE = UUID.fromString("00001800-0000-1000-8000-00805f9b34fb");

    public static final UUID HEART_RATE_CHARACTERISTIC = UUID.fromString("00002a00-0000-1000-8000-00805f9b34fb");
     ...
     *            待发送的数据,最大长度为20
     */
    public void sendData(BluetoothGattCharacteristic writeCharacteristic,String strData) {
        byte[] data =strData.getBytes();
        if (data != null && data.length > 0 && data.length < 21) {
            if (writeCharacteristic.setValue(data)
